// Generated on 2014-11-06 using generator-angular 0.7.1
'use strict';
  ...
  grunt.initConfig({
    ...
    autoprefixer: {
      ...
      dist: {
        files: [{
          expand: true,
          cwd: 'static/.tmp/styles/',
          src: '{,*/}*.css',
          dest: 'static/.tmp/styles/'
        }]
      }
    },
    ...
    compass: {
      options: {
        ...
        httpGeneratedImagesPath: '<%= yeoman.app %>/static/images/generated',
        httpFontsPath: '<%= yeoman.app %>/static/styles/fonts',
